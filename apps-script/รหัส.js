...
function processChatbot(userMessage) {
  ...
  if (msg.includes('เกณฑ์')) {
    reply = "เกณฑ์การประเมินตามชุดเครื่องมือนิเทศตาดีกา มี 5 แบบฟอร์มครับ:\n" +
      "แบบที่ 1 การนำหลักสูตรไปใช้ (45 คะแนน)\n" +
      "แบบที่ 2 การสังเกตการจัดการเรียนรู้ของครู (54 คะแนน)\n" +
      "แบบที่ 3 การวัดและประเมินผลผู้เรียน (51 คะแนน)\n" +
      "แบบที่ 4 การตรวจสอบผลลัพธ์ผู้เรียนแบบสุ่ม (15 คะแนน)\n" +
      "แบบที่ 5 สรุปผลรายศูนย์และแผนพัฒนา (เชิงคุณภาพ)\n" +
      "รวมแบบที่ 1-3 = 150 คะแนน คิดเป็นร้อยละและจัดระดับผลการนิเทศครับ";
    ...
    reply = "แต่ละข้อให้คะแนน 0-3 คะแนน โดยดูจากตัวบ่งชี้และหลักฐานที่ควรพิจารณาครับ ระบบจะคำนวณคะแนนรวม (150 คะแนน) ร้อยละ และระดับผลการนิเทศให้อัตโนมัติ";
  } else if (msg.includes('แบบที่ 4') || msg.includes('สุ่ม')) {
    reply = "แบบที่ 4 การตรวจสอบผลลัพธ์ผู้เรียนแบบสุ่ม ให้กรอกจำนวนผู้เรียนที่สุ่ม และจำนวนที่ทำได้ตามเกณฑ์ ระบบคำนวณร้อยละให้อัตโนมัติ แล้วให้คะแนนข้อ 1-5 (ข้อละ 0-3) ครับ";
  } else if (msg.includes('แบบที่ 5') || msg.includes('แผนพัฒนา')) {
    reply = "แบบที่ 5 สรุปผลรายศูนย์และแผนพัฒนา ให้กรอกจุดแข็ง ช่องว่าง สาเหตุ ทรัพยากรที่ต้องการ และจัดทำ Action Plan (ประเด็นพัฒนา/กิจกรรม/ผู้รับผิดชอบ/กำหนดเสร็จ/หลักฐาน) ใช้ปุ่ม \"ประมวลผลด้วย AI\" ช่วยร่างได้ครับ";
